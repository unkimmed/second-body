...
- **Always explain before acting**: Before running any command, installing packages, or editing/creating files, explain what you're about to do and wait for the user to confirm. The user decides whether to proceed.
